...
if (import.meta.url === pathToFileURL(process.argv[1] ?? "").href) check().then((message) => console.log(message)).catch((error) => { console.error(error.message); process.exitCode = 1; });
