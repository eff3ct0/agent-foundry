...
const pins: Record<string, string> = { "actions/checkout": "11bd71901bbe5b1630ceea73d27597364c9af683", "actions/upload-artifact": "ea165f8d65b6e75b540449e92b4886f43607fa02" };
export const check = async (projectRoot = root): Promise<string> => {
...
if (import.meta.url === pathToFileURL(process.argv[1] ?? "").href) check().then((message) => console.log(message)).catch((error: Error) => { console.error(error.message); process.exitCode = 1; });
