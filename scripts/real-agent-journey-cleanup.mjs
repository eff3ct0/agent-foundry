...
else cleanup({ template: values.template ?? "eff3ct0/factory-template", owner: values.owner, runId: values.run_id, output: values.output }).catch((error) => { process.stderr.write(`${error.message}\n`); process.exitCode = 1; });
