...
| Generic commands | `scripts/*.mjs`, `scripts/typed-inherited-runtime/*.js` | `.factory/scripts/` | Commands use explicit relocated paths; the label synchronizer runs from its packaged ESM runtime scope. |
