...
- Accepted exception evidence: the maintainer explicitly approved `size:exception` in the 1050-1300 review range for this cohesive retirement boundary. The legacy reporter removal, retained-test cleanup, lifecycle cleanup, ODD evidence, and regenerated payload mirror must remain one reviewable unit.
