...
- Review budget: the maintainer explicitly approved `size:exception` for this cohesive final child, forecast at 1,250-1,500 changed lines. This is the final child above H3 and cannot be split without leaving an invalid retained Python execution path.
